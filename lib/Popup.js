...
var propTypes = {
  ...
  PopupContainer: _propTypes3.elementType,
...
var Popup = (function(_React$Component) {
  ...
  Popup.prototype.render = function render() {
    ...
    var popupHeaderTime = _localizer2.default.format(
      props.slotStart,
      'dddd, DD MMMM',
      props.culture
    )
    ...
    if (PopupContainer)
      return _react2.default.createElement(
        'div',
        { ref: 'root', style: style, className: 'custom-rbc-overlay' },
        _react2.default.createElement(PopupContainer, {
          events: events,
          title: popupHeaderTime,
        })
      )
