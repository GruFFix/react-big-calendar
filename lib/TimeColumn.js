...
var TimeColumn = (function(_Component) {
  ...
  TimeColumn.prototype.renderTimeSliceGroup = function renderTimeSliceGroup(
    ...
    var _props = this.props,
      ...
      columnEvents = _props.columnEvents,
      weekCloseDays = _props.weekCloseDays,
      handleAddEvent = _props.handleAddEvent,
      view = _props.view
      ...
      isToday &&
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('div', {
            className: 'today-border left',
          }),
          _react2.default.createElement('div', {
            className: 'today-border right',
          })
        ),
      renderedSlots,
      children
