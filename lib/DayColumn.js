  ...
  DayColumn.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        ...
        style: style,
        isToday: _dates2.default.eq(max, current, 'day'),
        getNow: getNow,
        min: min,
        max: max,
        step: step,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function() {
    ...
    return styledEvents.map(function(_ref2, idx) {
      ...
      var _isSelected = (0, _selection.isSelected)(
        event,
  ...
  this._select = function() {
    ...
    _helpers.notify.apply(
      undefined,
      [_this2.props.onSelectEvent].concat(newArgs)
    )
  }
