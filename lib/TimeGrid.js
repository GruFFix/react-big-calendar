...
var TimeGrid = (function(_Component) {
  ...
  TimeGrid.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'rbc-month-view-scroll' },
      _react2.default.createElement(
        'div',
        { className: isScrollClass },
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'rbc-row hide-rbc-row' },
        _react2.default.createElement(
          'div',
          {
      ...
      return resources.map(function(resource, j) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(HeaderComponent, {
            title: (0, _accessors.accessor)(resource, resourceTitleAccessor),
          })
        )
      })
    })
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function(date, i) {
      ...
      var header = _react2.default.createElement(HeaderComponent, {
        ...
        format: dayFormat,
        culture: culture,
        isToday: _dates2.default.eq(date, today, 'day'),
      ...
      return _react2.default.createElement(
        ...
        _dates2.default.eq(date, today, 'day') &&
          view !== 'work_week' &&
          view !== 'day' &&
          _react2.default.createElement(
            'div',
            { className: 'today-border-box' },
            _react2.default.createElement('div', {
              className: 'today-border left header',
            }),
            _react2.default.createElement('div', {
              className: 'today-border right header',
            })
          )
      )
    })
